...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 2. Transisi Intro + Otomatis Putar Musik saat Tombol Start Diklik
  if (startBtn) {
    startBtn.addEventListener("click", () => {
      // Putar lagu saat tombol diklik
      if (music && !isPlaying) {
        music.play().then(() => {
          if (musicBtn) {
            musicBtn.classList.add("playing");
          ...
          console.log("Audio block error:", err);
        });
      }
